...
function setupTableSorting() {
	...
	tables.each(function(table) {
		...
		thTags.each(function(th) {
			// get the value of the 'moosort' property of the <th> element and add it to the parsers array
			// unset moosort property means try to automatically determine the parser to use (null gets added as element of parsers array)
		...
		x = new HtmlTable(table, {sortable: true, parsers: parsers, sortIndex: null});
	});
}