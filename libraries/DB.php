<?
	class DB {
		...
		static function valueToBoolean($value) {
			switch($value) {
				case 't': return true;
				case 'f': return false;
			}
		}
		static function booleanToValue($bool) {
			if($bool) return 't';
			else return 'f';
		}
		static function empty2null($value) {
			if(is_string($value) && strlen($value) == 0) return null;
			return $value;
		}
	}	